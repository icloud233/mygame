...
background=pygame.image.load("C:/Users/52439/Pictures/Camera Roll/233.jpg")
playerimg = pygame.image.load(path.join(img_dir,"player.png"))

bgm=pygame.mixer.Sound("C:/Users/52439/Downloads/Nevada.wav")
bgm.play(-1)

mybulletimg=pygame.image.load("C:/Users/52439/Desktop/编程/game/img/mylaser.png")
...
explosion_anim = []
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion00.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion01.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion02.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion03.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion04.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion05.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion06.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion07.png"))
explosion_anim.append(pygame.image.load("C:/Users/52439/Downloads/img/regularExplosion08.png"))
...
while keep_going:
    ...
    hits = pygame.sprite.groupcollide(bullet_sprites,enemy1_sprites,True,False) #我的子弹击中敌人
    for hit in hits:
